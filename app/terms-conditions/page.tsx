  ...
  return (
    <Container className="py-20">
      ...
      <p className="font-quicksand pb-4">
        ...
        refer to Square One. Square One offers this website, including all information, tools and
        Services available from this site to you, the user, conditioned upon your acceptance of all
        terms, conditions, policies and notices stated here. By visiting our site and/ or purchasing
      ...
      <p className="font-quicksand pb-4">
        (if applicable) Certain products or Services may be available exclusively online through the
        ...
        or product pricing are subject to change at anytime without notice, at the sole discretion
        of us. We reserve the right to discontinue any product at any time. Any offer for any
        product or service made on this site is void where prohibited. We do not warrant that the
      ...
      <p className="font-quicksand pb-4">
        ...
        your use of optional third-party tools. Any use by you of the optional tools offered through
        the site is entirely at your own risk and discretion and you should ensure that you are
        familiar with and approve of the terms on which tools are provided by the relevant
        third-party provider(s). We may also, in the future, offer new Services and/or features
        through the website (including, the release of new tools and resources). Such new features
      ...
      <p className="font-quicksand pb-4">
        ...
        To view our Privacy Policy, please see{' '}
      ...
      <p className="font-quicksand pb-4">
        ...
        governed by and construed in accordance with the laws of Uruguay.
      </p>
